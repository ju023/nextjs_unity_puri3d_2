// app/components/toppage/TopApp.tsx
...
export default function TopApp() {
  return (
    ...
    // メインコンテンツ
    <main className="p-8 bg-green-50 min-h-screen text-gray-800 font-cinecaption">
      {/* タイトル＆キャラ画像 */}
      {/* 文字 + logo と puri3dmodel 横並び配置 */}
      <div id="home" className="mb-72"></div>
      <section>
        <div className="mt-1 mb-1 flex flex-col md:flex-row items-center gap-8 justify-center">
          {/* 文字 と logo 縦並び配置 */}
      ...
      {/* 遊び方 */}
      <div id="howtoplay" className="mb-24"></div>
      <section>
        <div className="border-t-4 border-gray-200 shadow"></div>
